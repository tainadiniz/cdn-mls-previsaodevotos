...
with st.expander('Modelo', expanded=False):
    st.markdown('''
            ...
            Este Aplicativo possibilita que se faça previsões sobre a eleição ou não de um candidato a vereador no estado da Paraíba apartir de dados das eleições de 2020 usando uma modelagem de `Machine Learning`.
...
gastos = st.number_input("Informe sua verba de campanha:", value=0)
